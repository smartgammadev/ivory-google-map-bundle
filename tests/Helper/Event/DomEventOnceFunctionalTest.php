...
use Ivory\Tests\GoogleMap\Helper\Functional\Event\DomEventOnceFunctionalTest as BaseDomEventOnceFunctionalTest;

/**
 * @group functional
 */
class DomEventOnceFunctionalTest extends BaseDomEventOnceFunctionalTest
{
    /** {@inheritdoc} */
