...
use Ivory\Tests\GoogleMap\Helper\Functional\Overlay\PolylineFunctionalTest as BasePolylineFunctionalTest;

/**
 * @group functional
 */
class PolylineFunctionalTest extends BasePolylineFunctionalTest
{
    /** {@inheritdoc} */
