...
``` bash
$ git clone git@github.com:your-name/IvoryGoogleMapBundle.git
$ git checkout -b bug-fix-description
```

Then, we recommend to use [Docker](https://www.docker.com) and follow this [instructions](/docs/development_environment.md) in 
...
``` bash
$ git remote add upstream git@github.com:egeloen/IvoryGoogleMapBundle.git
