...
use Ivory\Tests\GoogleMap\Helper\Functional\Overlay\GroundOverlayFunctionalTest as BaseGroundOverlayFunctionalTest;

/**
 * @group functional
 */
class GroundOverlayFunctionalTest extends BaseGroundOverlayFunctionalTest
{
    /** {@inheritdoc} */
